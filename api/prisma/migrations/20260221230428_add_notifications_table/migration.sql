...
INSERT INTO "new_shouts" ("content", "created_at", "id", "is_deleted", "media_id", "media_meta", "media_type", "media_url", "parent_id", "user_id") SELECT "content", "created_at", "id", "is_deleted", "media_id", "media_meta", "media_type", "media_url", "parent_id", "user_id" FROM "shouts";
DROP TABLE "shouts";
...
INSERT INTO "new_users" ("avatar", "created_at", "email", "id", "is_banned", "password_hash", "username") SELECT "avatar", "created_at", "email", "id", "is_banned", "password_hash", "username" FROM "users";
DROP TABLE "users";
