-- DropIndex
DROP INDEX "idx_shouts_content_trgm";
...
CREATE TABLE "gif_favorites" (
    ...
    "giphy_still" TEXT NOT NULL DEFAULT '',
...
-- CreateIndex
CREATE UNIQUE INDEX "gif_favorites_user_id_giphy_id_key" ON "gif_favorites"("user_id", "giphy_id");
