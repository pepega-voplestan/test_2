...
const SearchDropdown: React.FC<SearchDropdownProps> = ({ onFocusChange }) => {
  ...
  return (
    <>
      <div ref={pillRef} className={`flex items-center sm:justify-end${focused ? ' flex-1 min-w-0 ml-1 sm:ml-0 sm:flex-none sm:w-[380px] relative z-50' : ' sm:w-56'}`}>
      {!focused ? (
        ...
        <div
          className="flex items-center rounded-full bg-th-input ring-1 ring-th-border w-full"
          style={{ height: '36px' }}
        >
