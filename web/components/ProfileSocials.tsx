...
/* ───────────────────────── SVG Icons ───────────────────────── */
/* Inline SVGs — no external icon deps, max cross-browser compat */

const SteamIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
    <path d="M12 2a10 10 0 0 0-9.96 9.04l5.12 2.11a2.85 2.85 0 0 1 1.57-.47c.18 0 .35.02.53.05l2.35-3.4v-.06a3.56 3.56 0 1 1 3.56 3.56h-.1l-3.34 2.38c.01.16.02.33.02.5a2.85 2.85 0 0 1-5.65.5L2.1 14.83A10 10 0 1 0 12 2zm-2.43 16.41a2.14 2.14 0 0 0 1.18-2.78 2.14 2.14 0 0 0-1-.97l1.23-.51c.32.2.59.48.78.82a2.86 2.86 0 0 1-1.57 3.72l-.62-.28zm6.97-7.13a2.37 2.37 0 1 0-2.38-2.37 2.37 2.37 0 0 0 2.38 2.37z"/>
  </svg>
);
      ...
      {socials.map((s) => {
        ...
        return (
          <a
            ...
            className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-th-ring/5 hover:bg-th-ring/10 border border-th-border-2 text-th-text-2 hover:text-th-text transition-colors text-sm select-none"
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isActive
                  ? 'bg-th-ring/10 border-th-border text-th-text hover:bg-th-ring/15'
                  : 'bg-th-ring/[0.03] border-th-border-2 text-th-text-4 opacity-40 hover:opacity-70 hover:bg-th-ring/5'
                }
